...
school = School('МБОУСОШ №10', '345068, г.Ростов-на-Дону, ул.Ученическая 8', teachers, students)
...
student = school.find_student('Садыкова Лилия Владимировна')
print('\nУченик: {0}\nУчебный класс: "{1}"\n'
...
print('\nКласс: "10А"\nПреподаватели: '
      '{0}'.format(', '.join(school.get_teachers('10А'))))